      ...
      <div className="flex justify-center items-center gap-7">
        <div className="group1 flex flex-col justify-center items-center gap-5">
          <div>
            <input
              type="text"
              className="px-7 py-3 bg-[#7A7A7A] rounded-full outline-0 ring-0 text-white"
            />
          </div>
          <div>
            <input
          ...
          <div>
            <button className="flex justify-center items-center text-white gap-4 bg-gradient-to-r  ">
              Forgot Password
            </button>
          </div>
        </div>
        <div className="group2 flex flex-col justify-center items-center gap-10">
          ...
          <div>
            <button
              type="button"
              className="flex justify-center items-center text-white gap-4"
            >
